...
// This is part of the Cursor prompt, but we don’t have any of these tools, so I’m removing it for now.
// I added `XXXXX` in a couple of places to avoid globs being interpreted as the end of a block comment.
...
// - ["src/**XXXXX/utils/**"] - globs
// - ["*.ts"] or ["**XXXXX/*"] - wildcard paths
//
// ### Search Strategy
//
