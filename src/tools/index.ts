...
${responseText}`;
  ...
  server.tool(
    ...
    It takes two arguments: code, which is an array of markdown code blocks containing HTML with custom elements, and packageName, which specifies the TypeScript library to validate against.
