...
export const ActionApiContentSchema = z
  .object({
    presentModal: z.function(),
  })
  .strict();

export const CartApiContentSchema = z
  .object({
...
export const CustomSaleSchema = z
  .object({
    price: z.string(),
    quantity: z.number(),
    taxable: z.boolean(),
...
export const SetLineItemPropertiesInputSchema = z
  .object({
...
export const SetLineItemDiscountInputSchema = z
  .object({
...
export const LineItemDiscountSchema = z
  .object({
    amount: z.string(),
    title: z.string(),
...
export const CartLineItemApiSchema = z
  .object({
    cartLineItem: z.string(),
  })
  .strict();

export const ConnectivityApiContentSchema = z
  .object({
    subscribable: z.string(),
  })
  .strict();

export const ConnectivityStateSchema = z
  .object({
    internetConnected: z.string(),
  })
  .strict();

export const CustomerApiContentSchema = z
  .object({
    id: z.number(),
  })
  .strict();

export const DeviceApiContentSchema = z
  .object({
...
export const DraftOrderApiContentSchema = z
  .object({
...
export const LocaleApiContentSchema = z
  .object({
    subscribable: z.string(),
  })
  .strict();

export const NavigationApiContentSchema = z
  .object({
    dismiss: z.function(),
    navigate: z.function(),
    pop: z.function(),
...
export const OrderApiContentSchema = z
  .object({
    customerId: z.number().optional(),
    id: z.number(),
    name: z.string(),
...
export const PrintApiContentSchema = z
  .object({
    print: z.function(),
  })
  .strict();

export const ProductApiContentSchema = z
  .object({
    id: z.number(),
    variantId: z.number(),
  })
...
export const ProductSearchApiContentSchema = z
  .object({
...
export const MultipleResourceResultSchema = z
  .object({
...
export const ScannerApiContentSchema = z
  .object({
...
export const ScannerSubscriptionResultSchema = z
  .object({
...
export const SessionApiContentSchema = z
  .object({
...
export const ToastApiContentSchema = z
  .object({
    show: z.function(),
  })
  .strict();

export const ShowToastOptionsSchema = z
  .object({
...
export const BannerPropsSchema = z
  .object({
...
export const CameraScannerPropsSchema = z
  .object({
    bannerProps: z.string().optional(),
  })
  .strict();

export const CameraScannerBannerPropsSchema = z
  .object({
    title: z.string(),
    variant: z.string(),
    visible: z.boolean(),
...
export const DateFieldPropsSchema = z
  .object({
    action: z.string().optional(),
...
export const EmailFieldPropsSchema = z
  .object({
    action: z.string().optional(),
    disabled: z.boolean().optional(),
    error: z.string().optional(),
...
export const ListRowLeftSideSchema = z
  .object({
...
export const SubtitleTypeSchema = z
  .object({
...
export const ListRowRightSideSchema = z
  .object({
...
export const ToggleSwitchSchema = z
  .object({
    disabled: z.boolean().optional(),
...
export const NavigatorPropsSchema = z
  .object({
    initialScreenName: z.string().optional(),
  })
  .strict();

export const NumberFieldPropsSchema = z
  .object({
    action: z.string().optional(),
    disabled: z.boolean().optional(),
    error: z.string().optional(),
...
export const POSBlockPropsSchema = z
  .object({
    action: z.function().optional(),
  })
  .strict();

export const POSBlockRowPropsSchema = z
  .object({
    onPress: z.function().optional(),
  })
  .strict();

export const PinPadPropsSchema = z
  .object({
    label: z.string().optional(),
...
export const PinPadActionTypeSchema = z
  .object({
    label: z.string(),
    onPress: z.function(),
  })
...
export const PrintPreviewPropsSchema = z
  .object({
    src: z.string(),
  })
  .strict();

export const QRCodePropsSchema = z
  .object({
    value: z.string(),
  })
  .strict();

export const RadioButtonListPropsSchema = z
  .object({
...
export const ScreenPresentationPropsSchema = z
  .object({
    sheet: z.boolean().optional(),
  })
  .strict();

export const SecondaryActionPropsSchema = z
  .object({
...
export const SearchBarPropsSchema = z
  .object({
    editable: z.boolean().optional(),
...
export const SectionHeaderActionSchema = z
  .object({
    onPress: z.function(),
    title: z.string(),
  })
...
export const SectionHeaderPropsSchema = z
  .object({
    action: z.function().optional(),
...
export const SelectablePropsSchema = z
  .object({
    disabled: z.boolean().optional(),
    onPress: z.function(),
  })
...
export const StepperPropsSchema = z
  .object({
    disabled: z.boolean().optional(),
...
export const NewTextFieldPropsSchema = z
  .object({
    action: z.string().optional(),
    disabled: z.boolean().optional(),
    error: z.string().optional(),
...
export const TimeFieldPropsSchema = z
  .object({
    action: z.string().optional(),
    disabled: z.boolean().optional(),
    error: z.string().optional(),
...
export const TimePickerPropsSchema = z
  .object({
    inputMode: z.enum(["inline", "spinner"]).optional(),
    is24Hour: z.boolean().optional(),
    onChange: z.function().optional(),
...
export const CartUpdateEventDataSchema = z
  .object({
    cart: z.string(),
...
export const CashTrackingSessionCompleteDataSchema = z
  .object({
...
export const CashTrackingSessionStartDataSchema = z
  .object({
...
export const TransactionCompleteWithReprintDataSchema = z
  .object({
    connectivity: z.string(),
    device: z.string(),
    locale: z.string(),
...
export const SaleTransactionDataSchema = z
  .object({
    balanceDue: z.string(),
    customer: z.string().optional(),
...
export const ShippingLineSchema = z
  .object({
...
export const ReturnTransactionDataSchema = z
  .object({
    balanceDue: z.string(),
    customer: z.string().optional(),
    discounts: z.string().optional(),
...
export const ExchangeTransactionDataSchema = z
  .object({
    balanceDue: z.string(),
    customer: z.string().optional(),
    discounts: z.string().optional(),
...
export const ReprintReceiptDataSchema = z
  .object({
    balanceDue: z.string(),
    customer: z.string().optional(),
    discounts: z.string().optional(),
...
export const TransactionCompleteDataSchema = z
  .object({
    connectivity: z.string(),
    device: z.string(),
    locale: z.string(),
